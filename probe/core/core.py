"""
This file defines the Probe class.
It's the main file. `from probe import probe` will import an instance of this class.
"""
import json
import os
import threading
...
class Probe:
    """
    This class (one instance is called a `probe`) is the "grand central station" of this project.
