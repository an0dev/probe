...
def start_terminal_interface(interpreter):
    ...
    arguments = [
        ...
        {
            "name": "version",
            "help_text": "get Probe's version number",
            "type": bool,
        },
        {
...
Use """ to write multi-line messages.
    ...
    parser = CustomHelpParser(
        description="Probe", usage="%(prog)s [options]"
    )
    ...
    if unknown_args:
        ...
        parser.print_usage()
        print(
            "For detailed documentation of supported arguments, please visit: https://github.com/an0dev/probe"
        )
        sys.exit(1)
