...
You are capable of **any** task.""",
        """You are Probe, a world-class programmer that can complete
...
# safe_mode: "off"  # The safety mode (see https://github.com/an0dev/probe/usage/safe-mode)
...
# All options: https://github.com/an0dev/probe/settings
...
def determine_user_version():
    # Pre 0.2.0 directory
    old_dir_pre_020 = platformdirs.user_config_dir("Probe")
    # 0.2.0 directory
    old_dir_020 = platformdirs.user_config_dir("Probe Terminal")
...
def migrate_user_app_directory():
    ...
    if user_version == "pre_0.2.0":
        old_dir = platformdirs.user_config_dir("Probe")
        migrate_app_directory(old_dir, oi_dir, profile_dir)

    elif user_version == "0.2.0":
        old_dir = platformdirs.user_config_dir("Probe Terminal")
        migrate_app_directory(old_dir, oi_dir, profile_dir)
