...
def validate_llm_settings(interpreter):
        ...
        if interpreter.offline:
            ...
            if interpreter.llm.model in [
                ...
                if (
                    ...
                    To use another language model, run `interpreter --local` or consult the documentation at [docs.openinterpreter.com](https://github.com/an0dev/probe/language-model-setup/).
    ...
    if len(interpreter.messages) == 1:
        ...
        # interpreter.display_message(f"\n*{interpreter.llm.model} via Probe:*")
        pass
