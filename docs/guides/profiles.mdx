...
If you want to make your own profile, start with the [Template Profile](https://github.com/OpenInterpreter/probe/blob/main/interpreter/terminal_interface/profiles/defaults/template_profile.py).

To apply a Profile to an Probe session, you can run `interpreter --profile <name>`
