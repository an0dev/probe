...
**Probe** works with both hosted and local language models.
...
For this reason, we recommend starting with a **hosted** model, then switching to a local model once you've explored Probe's capabilities.
...
<Info>
  ...
  efforts in connecting Probe to hosted providers.
</Info>
