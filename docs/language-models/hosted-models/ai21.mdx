...
To use Probe with a model from AI21, set the `model` flag:

<CodeGroup>

```bash Terminal
probe --model j2-light
```

```python Python
from probe import probe

probe.llm.model = "j2-light"
probe.chat()
```
...
probe --model j2-light
probe --model j2-mid
probe --model j2-ultra
```

```python Python
probe.llm.model = "j2-light"
probe.llm.model = "j2-mid"
probe.llm.model = "j2-ultra"
```
