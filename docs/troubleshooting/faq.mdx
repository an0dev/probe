...
<Accordion title="Does Probe ensure that my data doesn't leave my computer?">
  ...
  [function](https://github.com/OpenInterpreter/probe/blob/main/interpreter/core/core.py#L167)
